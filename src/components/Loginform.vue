        ...
        <q-card square bordered class="q-pa-lg shadow-1">
          <q-card-section>
            <q-form class="q-gutter-md">
              <q-input square filled clearable v-model="email" type="email" label="email" required/>
              <q-input square filled clearable v-model="password" type="password" label="password" required/>
            </q-form>
          </q-card-section>
